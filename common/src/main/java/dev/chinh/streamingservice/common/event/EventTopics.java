...
public class EventTopics {
    ...
    public static final String MEDIA_SEARCH_BACKUP_AND_FILE_TOPIC = "media-search-backup-and-file-event";
    ...
    public static final String MEDIA_SEARCH_BACKUP_AND_OBJECT_TOPIC = "media-search-backup-object-event";
