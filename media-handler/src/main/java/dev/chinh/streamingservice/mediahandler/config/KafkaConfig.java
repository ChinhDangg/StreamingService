package dev.chinh.streamingservice.mediahandler.config;
...
public class KafkaConfig {
    ...
    public KafkaAdmin.NewTopics mediaTopics() {
        return new KafkaAdmin.NewTopics(
                TopicBuilder.name(EventTopics.MEDIA_FILE_TOPIC)
                        .partitions(1)
                        .replicas(1)
    ...
    public static final String MEDIA_GROUP_ID = "media-handler-service";
