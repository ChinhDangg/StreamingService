package dev.chinh.streamingservice.backend.data.service;

import dev.chinh.streamingservice.backend.data.projection.MediaNameEntry;
import dev.chinh.streamingservice.backend.data.repository.MediaAuthorRepository;
import dev.chinh.streamingservice.backend.data.repository.MediaCharacterRepository;
import dev.chinh.streamingservice.backend.data.repository.MediaTagRepository;
import dev.chinh.streamingservice.backend.data.repository.MediaUniverseRepository;
